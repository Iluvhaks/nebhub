-- Nebula Hub Universal - Full Raw Script with All Tabs + BABFT Autofarm (Fixed)
-- Made by Elden and Nate, now with stable BABFT flying autofarm
        ...
        while remLag do
            for _,o in ipairs(workspace:GetDescendants()) do
                if o:IsA("RemoteEvent") or o:IsA("RemoteFunction") then
                    pcall(function() if o:IsA("RemoteEvent") then o:FireServer("NebulaSpam") else o:InvokeServer("NebulaSpam") end end)
                end
            end
            task.wait(0.05)
        end
...
do
    ...
    workspace.ChildRemoved:Connect(function(obj)
        local part = grabMap[obj]; grabMap[obj]=nil
        ...
        while autofarmEnabled do
            ...
            if hrp then
                ...
                if TSBTargetPlayer and TSBTargetPlayer.Character then
                    ...
                    if tHRP then
                        TweenService:Create(hrp,TweenInfoTSB,{CFrame = tHRP.CFrame * CFrame.new(0,3,0)}):Play()
                    end
                end
            end
            task.wait(0.1)
